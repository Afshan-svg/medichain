...
import Med from './pages/MedicalHistory1';
import Insurance2 from './pages/Insurance2';
import MedicalHistory1 from './pages/MedicalHistory1';
    ...
    <div className={currentMode === 'Dark' ? 'dark' : ''}>
      <BrowserRouter>
              <Routes>
                ...
                <Route path="/medicalhistory1" element={<Med/>} />
                ...
                <Route exact path="/patientData/:phash" element={<MedicalHistory1 />} />
