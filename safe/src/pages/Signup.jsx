               ...
               [ shadow-black/70 shadow-2xl ]">
                ...
                <div className="input-container">
                    ...
                    <div className="input-div">
                        ...
                        <input onChange={(e) => handle(e)} type="mail" placeholder="Your Blood Group" id="BloodGroup" name="bloodgroup" />
                    ...
                    {type &&
                        <div className="input-div" style={{ display: 'flex', gap: '1rem' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                <input onChange={(e) => handleD(e)} type="text" placeholder="Address" id="email" name="address" />
                            </div>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className="input-heading">
                                    <i className="fas fa-key"></i>
